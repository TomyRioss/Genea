  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const [topUrl, bottomUrl] = await Promise.all([
        uploadImage("prendas-separadas", "upload", userId, imageFiles.top!),
        uploadImage("prendas-separadas", "upload", userId, imageFiles.bottom!),
      ]);
    ...
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="space-y-3">
          ...
          <ImageUpload onImageSelect={(file) => handleImageSelect(file, "top")} />
          <Input
        ...
        <div className="space-y-3">
          ...
          <ImageUpload onImageSelect={(file) => handleImageSelect(file, "bottom")} />
          <Input
            placeholder="Descripción de la prenda... (opcional)"
